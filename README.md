...
<table>
                      ...
                      <tr>
                        <th style="color:orange;background-color:#6e1718;font-size:1rem;font-family:Roboto;border-radius:5px"><img src="html.png" style="width:30px;height:30px"/><img src="css.png"style="width:30px;height:30px"/>html & css</th>
                        <th style="color:orange;background-color:#7e1f89;font-size:1rem;font-family:Roboto;border-radius:5px">100%</th>
                      </tr>
                          <tr>
                            <th style="color:orange;background-color:#6e1718;font-size:1rem;font-family:Roboto;border-radius:5px"><img src="java.png" class="javalogo" style="width:30px;height:30px"/>JAVASCRIPT (learning)</th>
                        <th style="color:orange;background-color:#7e1f89;font-size:1rem;font-family:Roboto;border-radius:5px">75%</th>
                      </tr>
                         <tr>
                        <th style="color:orange;background-color:#6e1718;font-size:1rem;border-radius:5px"><img src="python.png"style="width:30px;height:30px"/>phyton</th>
                        <th style="color:orange;background-color:#7e1f89;font-size:1rem;border-radius:5px">25-35%</th>
                      </tr>
                           <tr>
                        <th style="color:orange;background-color:#6e1718;font-size:1rem;border-radius:5px"><img src="https://raw.githubusercontent.com/github/explore/80688e429a7d4ef2fca1e82350fe8e3517d3494d/topics/markdown/markdown.png"style="width:30px;height:30px"/>Markdown</th>
...
![Hailemariam's GitHub Stats](https://github-readme-stats.vercel.app/api?username=hailedev5-dotcom&show_icons=true&theme=radial)
...
<div class="social-icons">
             ...
             <a href="https://github.com/hailedev5-dotcom" style="display:flex;justify-content: center;align-items: center;margin:20px 10px" id="hi"><img src="github.png" alt="github icon" style="height:40px;width:40px"></a>
